...
export const DATA = {
  ...
  description:
    "TCSer and Computer Science Engineer [AI & ML] specializing in AI-driven automation, backend systems, and scalable cloud infrastructure. Creator of Nexiuo, an Instagram automation platform for businesses & creators to scale engagement using AI. I love building products, solving real problems, and bringing ideas to life.",
  summary:
    "Currently working as a TCSer at Tata Consultancy Services (TCS). Experienced in backend engineering using Python, TypeScript, Flask, Next.js & REST APIs, with hands-on work in distributed systems, Docker, Cloudflare, and Azure. Practical exposure to Cybersecurity, GenAI, and data-driven automation. Strong problem-solving mindset, rapid learner, and passionate about backend, cloud, and AI engineering roles that demand innovation and performance.",
  avatarUrl: "/me.png",
  skills: [
    ...
    { name: "Oracle Cloud", icon: undefined },
    ...
    { name: "Meta Graph API", icon: undefined },
    { name: "GenAI", icon: undefined },
    { name: "Data Analysis", icon: undefined },
    { name: "Visualization", icon: undefined },
    { name: "Better-Auth", icon: undefined },
